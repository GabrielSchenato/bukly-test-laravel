            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="pt-4 pr-6 flex justify-end">
                    <a href="{{ route('rooms.create')}}"
                       class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Create Room
                    </a>
                </div>
                    ...
                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @foreach($rooms as $room)
                                <tr>
                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap font-bold">{{$room->name}}</td>
                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{\Illuminate\Support\Str::words($room->description, 5)}}</td>
